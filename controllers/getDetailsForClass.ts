...
export const clickAndGet = async (req: Request, res: Response) => {
    ...
    const Range1 = new Date(`${currentTime.getFullYear()}-${currentTime.getMonth() + 1}-${currentTime.getDate()}T23:00:00`)
    const Range2 = new Date(`${currentTime.getFullYear()}-${currentTime.getMonth() + 1}-${currentTime.getDate()}T10:00:00`)
    ...
    const Range3 = new Date(`${currentTime.getFullYear()}-${currentTime.getMonth() + 1}-${currentTime.getDate()}T08:00:00`)
    const Range4 = new Date(`${currentTime.getFullYear()}-${currentTime.getMonth() + 1}-${currentTime.getDate()}T09:00:00`)
    ...
    const Range5 = new Date(`${currentTime.getFullYear()}-${currentTime.getMonth() + 1}-${currentTime.getDate()}T01:00:00`)
    const Range6 = new Date(`${currentTime.getFullYear()}-${currentTime.getMonth() + 1}-${currentTime.getDate()}T02:00:00`)
